  ...
  return (
    <><>
      ...
      <div className=' flex flex-col max-w-xl min-w-max m-auto' style={{ maxWidth: '600px', minWidth: '600px' }}>
        ...
        <ToastContainer />
        {cert&& !cert.editor 
            &&<div className='h-96 pt-48 text-2xl'>You are not a editor
            {/* {router.push("/")} */}
            </div>
        }
         {cert&&cert.editor&& <>
        <div ref={ref} className='flex justify-center'>
          ...
          <div className=' absolute pt-60 mt-2 w-128 text-xl leading-5 font-Italianno'>Roll No - <span className='font-semibold'>{cert.roll}</span>, Year - <span className='font-semibold'>{cert.year} year</span> of ECE, RKMGEC, has provided significant effort towards design and development of departmental cultural magazine of ECE named  &quot;
